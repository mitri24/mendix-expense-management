...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p8.FeedbackModule.PopupSuccess.layoutGrid1"
        $widgetId="p8.FeedbackModule.PopupSuccess.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p8.FeedbackModule.PopupSuccess.layoutGrid1$row0"
                $widgetId="p8.FeedbackModule.PopupSuccess.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p8.FeedbackModule.PopupSuccess.layoutGrid1$row0$column0"
                        $widgetId="p8.FeedbackModule.PopupSuccess.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p8.FeedbackModule.PopupSuccess.dataView1"
                                ...
                                body={[
                                    <$Container key="p8.FeedbackModule.PopupSuccess.container1"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Image key="p8.FeedbackModule.PopupSuccess.image1"
                                                ...
                                                style={undefined}
                                                tabIndex={undefined} />,
                                            <$Text key="p8.FeedbackModule.PopupSuccess.text1"
                                                ...
                                                renderMode={"h3"} />,
                                            <$ActionButton key="p8.FeedbackModule.PopupSuccess.actionButton2"
...
export const cancelChangesOperationId = "4dyEdutmnlucXwsBWwTDTA";
export const style = {};
