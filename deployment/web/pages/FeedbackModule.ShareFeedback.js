...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p10.FeedbackModule.ShareFeedback.layoutGrid1"
        $widgetId="p10.FeedbackModule.ShareFeedback.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p10.FeedbackModule.ShareFeedback.layoutGrid1$row0"
                $widgetId="p10.FeedbackModule.ShareFeedback.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p10.FeedbackModule.ShareFeedback.layoutGrid1$row0$column0"
                        $widgetId="p10.FeedbackModule.ShareFeedback.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p10.FeedbackModule.ShareFeedback.dataView5"
                                ...
                                object={NanoflowObjectProperty({
                                    "dataSourceId": "p10.20",
                                    "editable": true,
                                    "source": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.DS_Feedback_Populate").DS_Feedback_Populate, "allowedRoles": [] },
                                    "argMap": {}
                                })}
                                ...
                                body={[
                                    <$Container key="p10.FeedbackModule.ShareFeedback.container5"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Text key="p10.FeedbackModule.ShareFeedback.text1"
                                                ...
                                                renderMode={"p"} />,
                                            <$FormGroup key="p10.FeedbackModule.ShareFeedback.feedback_subject$formGroup"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.feedback_subject$formGroup"
                                                class={"mx-name-feedback_subject mx-textbox"}
                                                style={undefined}
                                                control={[
                                                    <$TextBox key="p10.FeedbackModule.ShareFeedback.feedback_subject"
                                                        ...
                                                        inputValue={AttributeProperty({
                                                            ...
                                                            "attribute": "Subject",
                                                            "onChange": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.OCH_Feedback_SaveToLocalStorage").OCH_Feedback_SaveToLocalStorage, "allowedRoles": [] }, "disabledDuringExecution": false },
                                                            "isList": false,
                                                            "validation": null,
                                                            "formatting": { }
                                                        })}
                                            ...
                                            <$FormGroup key="p10.FeedbackModule.ShareFeedback.textArea2$formGroup"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.textArea2$formGroup"
                                                class={"mx-name-textArea2 mx-textarea"}
                                                style={undefined}
                                                control={[
                                                    <$TextArea key="p10.FeedbackModule.ShareFeedback.textArea2"
                                        ...
                                        ariaHidden={false} />,
                                    <$Container key="p10.FeedbackModule.ShareFeedback.container4"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Label key="p10.FeedbackModule.ShareFeedback.label1"
                                            ...
                                            <$Text key="p10.FeedbackModule.ShareFeedback.text2"
                                        ...
                                        ariaHidden={false} />,
                                    <$Container key="p10.FeedbackModule.ShareFeedback.container2"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.actionButton4$visibility"
                                                ...
                                                contents={[
                                                    <$ActionButton key="p10.FeedbackModule.ShareFeedback.actionButton4"
                                                        ...
                                                        action={ActionProperty({
                                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.ACT_Feedback_TriggerScreenshotMode").ACT_Feedback_TriggerScreenshotMode, "allowedRoles": [] }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />
                                                ]} />,
                                            <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.actionButton5$visibility"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.actionButton5$visibility"
                                                visible={ExpressionProperty({
                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [] }, "args": {} }
                                                })}
                                                contents={[
                                                    <$ActionButton key="p10.FeedbackModule.ShareFeedback.actionButton5"
                                                        ...
                                                        action={ActionProperty({
                                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.ACT_Feedback_UploadImage").ACT_Feedback_UploadImage, "allowedRoles": [] }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />
                                                ]} />
                                        ]}
                                        ariaHidden={false} />,
                                    <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.container6$visibility"
                                        ...
                                        contents={[
                                            <$Container key="p10.FeedbackModule.ShareFeedback.container6"
                                                ...
                                                onClick={undefined}
                                                content={[
                                                    <$Container key="p10.FeedbackModule.ShareFeedback.container7"
                                                        ...
                                                        onClick={undefined}
                                                        content={[
                                                            <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.actionButton1$visibility"
                                                                $widgetId="p10.FeedbackModule.ShareFeedback.actionButton1$visibility"
                                                                visible={ExpressionProperty({
                                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [] }, "args": {} }
                                                                })}
                                                                contents={[
                                                                    <$ActionButton key="p10.FeedbackModule.ShareFeedback.actionButton1"
                                                                        ...
                                                                        action={ActionProperty({
                                                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.ACT_Feedback_ClearImage").ACT_Feedback_ClearImage, "allowedRoles": [] }, "disabledDuringExecution": true },
                                                                            "abortOnServerValidation": true
                                                                        })} />
                                                                ]} />,
                                                            <$Image key="p10.FeedbackModule.ShareFeedback.image1"
                                    ...
                                    <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.textBox1$formGroup$visibility"
                                        ...
                                        contents={[
                                            <$FormGroup key="p10.FeedbackModule.ShareFeedback.textBox1$formGroup"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.textBox1$formGroup"
                                                class={"mx-name-textBox1 mx-textbox"}
                                                style={undefined}
                                                control={[
                                                    <$TextBox key="p10.FeedbackModule.ShareFeedback.textBox1"
                                    ...
                                    <$Container key="p10.FeedbackModule.ShareFeedback.container3"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p10.FeedbackModule.ShareFeedback.feedback_cancel"
                                            ...
                                            <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.feedback_clear$visibility"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.feedback_clear$visibility"
                                                visible={ExpressionProperty({
                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [] }, "args": {} }
                                                })}
                                                contents={[
                                                    <$ActionButton key="p10.FeedbackModule.ShareFeedback.feedback_clear"
                                                        ...
                                                        icon={undefined}
                                                        action={ActionProperty({
                                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.ACT_Feedback_ClearForm").ACT_Feedback_ClearForm, "allowedRoles": [] }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />
                                                ]} />,
                                            <$ConditionalVisibilityWrapper key="p10.FeedbackModule.ShareFeedback.feedback_submit$visibility"
                                                $widgetId="p10.FeedbackModule.ShareFeedback.feedback_submit$visibility"
                                                visible={ExpressionProperty({
                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [] }, "args": {} }
                                                })}
                                                contents={[
                                                    <$ActionButton key="p10.FeedbackModule.ShareFeedback.feedback_submit"
                                                        ...
                                                        icon={undefined}
                                                        action={ActionProperty({
                                                            "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p10.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require("/Users/mireiotrinley/Desktop/ERP_Projekt/deployment/web/nanoflows/FeedbackModule.ACT_SubmitFeedback").ACT_SubmitFeedback, "allowedRoles": [] }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />
                                                ]} />
                                        ]}
...
export const cancelChangesOperationId = "gK8eCwDbzFeg5pPrY8U0EA";
export const style = {};
