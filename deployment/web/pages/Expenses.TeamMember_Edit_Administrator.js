...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key="p25.Expenses.TeamMember_Edit_Administrator.container1"
        ...
        onClick={undefined}
        content={[
            <$Text key="p25.Expenses.TeamMember_Edit_Administrator.text40"
        ...
        ariaHidden={false} />,
    <$DataView key="p25.Expenses.TeamMember_Edit_Administrator.dataView2"
        ...
        body={[
            <$Div key="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3"
                ...
                style={undefined}
                content={[
                    <$Div key="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0"
                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0$column0"
                                $widgetId="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0$column0"
                                class={"col-lg col-md col Col-xs-12"}
                                style={undefined}
                                content={[
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.textBox1$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p25.Expenses.TeamMember_Edit_Administrator.textBox1"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.textBox2$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p25.Expenses.TeamMember_Edit_Administrator.textBox2"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.textBox3$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.textBox3$formGroup"
                                        class={"mx-name-textBox3 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p25.Expenses.TeamMember_Edit_Administrator.textBox3"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.comboBox2$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.comboBox2$formGroup"
                                        class={"mx-name-comboBox2"}
                                        style={undefined}
                                        control={[
                                            <$Combobox key="p25.Expenses.TeamMember_Edit_Administrator.comboBox2"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.comboBox3$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.comboBox3$formGroup"
                                        class={"mx-name-comboBox3"}
                                        style={undefined}
                                        control={[
                                            <$Combobox key="p25.Expenses.TeamMember_Edit_Administrator.comboBox3"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.radioButtons1$formGroup"
                                        ...
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p25.Expenses.TeamMember_Edit_Administrator.radioButtons1"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.switch1$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.switch1$formGroup"
                                        class={"mx-name-switch1"}
                                        style={undefined}
                                        control={[
                                            <$Switch key="p25.Expenses.TeamMember_Edit_Administrator.switch1"
                                    ...
                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.switch2$formGroup"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.switch2$formGroup"
                                        class={"mx-name-switch2"}
                                        style={undefined}
                                        control={[
                                            <$Switch key="p25.Expenses.TeamMember_Edit_Administrator.switch2"
                                    ...
                                    <$ConditionalVisibilityWrapper key="p25.Expenses.TeamMember_Edit_Administrator.actionButton3$visibility"
                                        $widgetId="p25.Expenses.TeamMember_Edit_Administrator.actionButton3$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p25.Expenses.TeamMember_Edit_Administrator.actionButton3"
                            ...
                            <$Div key="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0$column1"
                                $widgetId="p25.Expenses.TeamMember_Edit_Administrator.layoutGrid3$row0$column1"
                                class={"col-lg col-md col Cls-xs-12"}
                                style={undefined}
                                content={[
                                    <$DataView key="p25.Expenses.TeamMember_Edit_Administrator.dataView3"
                                        ...
                                        body={[
                                            <$Container key="p25.Expenses.TeamMember_Edit_Administrator.container2"
                                                ...
                                                onClick={undefined}
                                                content={[
                                                    <$Label key="p25.Expenses.TeamMember_Edit_Administrator.label1"
                                                ...
                                                ariaHidden={false} />,
                                            <$Container key="p25.Expenses.TeamMember_Edit_Administrator.container3"
                                                ...
                                                onClick={undefined}
                                                content={[
                                                    <$Image key="p25.Expenses.TeamMember_Edit_Administrator.image2"
                                                        ...
                                                        style={undefined}
                                                        tabIndex={undefined} />,
                                                    <$FormGroup key="p25.Expenses.TeamMember_Edit_Administrator.imageUploader1$formGroup"
                                                        ...
                                                        style={undefined}
                                                        control={[
                                                            <$FileManager key="p25.Expenses.TeamMember_Edit_Administrator.imageUploader1"
        ...
        hideFooter={false}
        footer={[
            <$ActionButton key="p25.Expenses.TeamMember_Edit_Administrator.actionButton1"
            ...
            <$ActionButton key="p25.Expenses.TeamMember_Edit_Administrator.actionButton2"
