...
const region$Main = [
    <$ScrollContainer key="l31.Atlas_Core.Tablet_Split_Left.layoutContainer"
        $widgetId="l31.Atlas_Core.Tablet_Split_Left.layoutContainer"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l31.Atlas_Core.Tablet_Split_Left.header1"
                    $widgetId="l31.Atlas_Core.Tablet_Split_Left.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l31.Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            $widgetId="l31.Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            content={PlaceholderProperty({
                                "id": "Atlas_Core.Tablet_Split_Left.HeaderLeft"
                            })} />
                    ]}
                    rightWidgets={[
                        <$Placeholder key="l31.Atlas_Core.Tablet_Split_Left.HeaderRight"
                            $widgetId="l31.Atlas_Core.Tablet_Split_Left.HeaderRight"
                            content={PlaceholderProperty({
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l31.Atlas_Core.Tablet_Split_Left.simpleMenuBar1"
                    $widgetId="l31.Atlas_Core.Tablet_Split_Left.simpleMenuBar1"
        ...
        left={{
            "enabled": true,
            "content": [
                <$Placeholder key="l31.Atlas_Core.Tablet_Split_Left.Left"
                    $widgetId="l31.Atlas_Core.Tablet_Split_Left.Left"
                    content={PlaceholderProperty({
        ...
        center={{
            "content": [
                <$Placeholder key="l31.Atlas_Core.Tablet_Split_Left.Main"
                    $widgetId="l31.Atlas_Core.Tablet_Split_Left.Main"
                    content={PlaceholderProperty({
