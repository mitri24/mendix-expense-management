...
const region$Main = [
    <$ScrollContainer key="l29.Atlas_Core.Tablet_BottomBar.layoutContainer"
        $widgetId="l29.Atlas_Core.Tablet_BottomBar.layoutContainer"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l29.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
                    $widgetId="l29.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l29.Atlas_Core.Tablet_BottomBar.Main"
                    $widgetId="l29.Atlas_Core.Tablet_BottomBar.Main"
